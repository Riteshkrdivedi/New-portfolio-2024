      ...
      <div className="container">
        ...
        <div className="">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            An Enthusiastic FullStack Web Developer
          </p>
        </div>

        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <Link href="#work" onClick={handleScroll} style={{ zIndex: 10 }}>
            <button className="inline-flex items-center gap-2 hover:bg-white hover:text-black transition-all border border-white/15 px-6 h-12 rounded-xl">
              <span className="font-semibold">Career Evolution</span>
              <ArrowDown className="size-4" />
            </button>
          </Link>
          <Link href="#contact" onClick={handleScroll} style={{ zIndex: 10 }}>
            <button className="inline-flex items-center gap-2 hover:bg-[#201f1fdb] hover:text-white transition-all border border-white bg-white text-gray-900 h-12 px-6 rounded-xl">
              <span>👋</span>
